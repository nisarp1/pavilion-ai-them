...
<div class="team-india-widget bg-grey-light-three m-b-xs-20">
    ...
    <div class="team-india-news-list">
        ...
        if ($team_india_category) {
            ...
            if ($team_india_posts->have_posts()):
                while ($team_india_posts->have_posts()):
                    $team_india_posts->the_post();
                    ?>
                            ...
                            <a href="<?php echo esc_url(get_permalink()); ?>" class="align-self-center">
                                ...
                                <?php else: ?>
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/placeholder.svg"
                                        alt="<?php the_title_attribute(); ?>" class="img-fluid" width="100" height="75"
                                        style="width: 100px; height: 75px; object-fit: cover;">
                                <?php endif; ?>
    ...
    <div class="widget-footer">
        <a href="<?php echo get_safe_category_link('team-india'); ?>" class="btn btn-link btn-small">View All Team India
            News →</a>
    </div>
</div>
