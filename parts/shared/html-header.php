...
// Default values
$og_title = $site_name . ' - News Beyond the Lines';
$og_description = 'Stay updated with the latest news from the Middle East. Byline Gulf delivers fact-filled news and promotional content across the Gulf region.';
...
$og_image = $base_url . $theme_base . '/assets/images/new/byline-gulf-social-share.jpg';

// Check if custom social share image exists, otherwise use site logo PNG
if (!file_exists(__DIR__ . '/../../assets/images/new/byline-gulf-social-share.jpg')) {
...
if (is_single() || is_page()) {
    ...
    if (empty($og_description)) {
        $og_description = 'Read the latest news and updates from Byline Gulf.';
    }
    ...
    if (has_post_thumbnail()) {
        ...
        $theme_base = get_theme_base_path();
        $default_share_image = $base_url . $theme_base . '/assets/images/new/byline-gulf-social-share.jpg';
        if (file_exists(__DIR__ . '/../../assets/images/new/byline-gulf-social-share.jpg')) {
...
<meta name="keywords" content="News, Middle East, Gulf, UAE, Dubai, Kerala, India, Business, Sports, Entertainment, Technology, Social Media">
...
<meta property="og:image:type" content="<?php echo (strpos($og_image, '.png') !== false) ? 'image/png' : 'image/jpeg'; ?>">
...
<meta property="article:author" content="Byline Gulf FZE">
...
<meta property="linkedin:owner" content="Byline Gulf FZE">
...
<!-- Favicon -->
<link rel="icon" type="image/png" href="<?php echo get_stylesheet_directory_uri(); ?>assets/images/new/favicon.png">
...
<link href="https://fonts.googleapis.com/css2?family=Anek+Malayalam:wght@100;200;300;400;500;600;700;800&display=swap&subset=malayalam" rel="stylesheet">
