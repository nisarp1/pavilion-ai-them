                                    ...
                                    <div class="media post-block small-block">
                                        ...
                                        <div class="media-body">
                                            <h4 class="axil-post-title small-card-title">
                                                <a
                                                    href="<?php echo esc_url($post_data['url']); ?>"><?php echo esc_html($post_data['title']); ?></a>
                                            </h4>
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="post-stats">
                                                <small class="text-muted">
                                                    ...
                                                    <?php echo number_format($post_data['view_count']); ?> views
                                                    <i class="far fa-comment ml-2"></i>
                                                    <?php echo number_format($post_data['comment_count']); ?> comments
                                                </small>
                                            </div>
                                        </div>
                                    </div>
