...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.isotope/3.0.6/isotope.pkgd.min.js"
    ...
    crossorigin="anonymous" referrerpolicy="no-referrer" defer></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/waypoints/4.0.1/shortcuts/infinite.min.js" defer></script>
...
<!-- IF ie -->
<script src="https://cdn.jsdelivr.net/npm/css-vars-ponyfill@2" defer></script>
<!-- Plugins -->
<script src="<?php echo get_stylesheet_directory_uri(); ?>assets/js/plugins.js" defer></script>
<!-- Custom Script -->
<script src="<?php echo get_stylesheet_directory_uri(); ?>assets/js/main.js" defer></script>
<!-- Sidebar Tabs Script -->
<script src="<?php echo get_stylesheet_directory_uri(); ?>assets/js/sidebar-tabs.js" defer></script>
<!-- Page-specific Fonts Script -->
<script src="<?php echo get_stylesheet_directory_uri(); ?>assets/js/page-specific-fonts.js" defer></script>
<!-- Exchange Rate Widget Script -->
<script>
    // Debug: Check what's being loaded
    console.log('🔍 Loading exchange rates script');
</script>
<script src="<?php echo get_stylesheet_directory_uri(); ?>assets/js/exchange-rates-simple.js?v=<?php echo time(); ?>"
    defer></script>
