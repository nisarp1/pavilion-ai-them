                ...
                <div class="col-lg-8">
                    <main class="site-main">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    if (!empty($prev_post)):
                                        ...
                                        <div class="nav-previous">
                                            <a href="<?php echo $prev_id ? get_permalink($prev_id) : '#'; ?>"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    if (!empty($next_post)):
                                        ...
                                        ?>
                                        <div class="nav-next">
                                            <a href="<?php echo $next_id ? get_permalink($next_id) : '#'; ?>"
                                                class="d-flex align-items-center">
                                                <div class="nav-content">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="media-body-title">
                                            <h3><a
                                                    href="<?php echo get_author_posts_url($author_id); ?>"><?php echo esc_html($author_name); ?></a>
                                            </h3>
                                            <?php if ($author_title): ?>
                        ...
                        <div class="facebook-comments-section m-b-xs-60">
                            ...
                            <div class="fb-comments" data-href="<?php echo esc_url(get_full_url(get_permalink())); ?>"
                                data-width="100%" data-numposts="5" data-colorscheme="light" data-order-by="social">
                            </div>
                        </div>
            ...
            <?php else:
                ...
                <div class="webstories-track webstories-track--fallback" role="list">
                    <?php foreach ($fallback_stories as $story): ?>
                        <article class="webstory-card" role="listitem" data-story="<?php echo esc_attr($story['key']); ?>"
                            data-cover="<?php echo esc_url($story['image']); ?>"
                            data-title="<?php echo esc_attr($story['title']); ?>">
                            <button type="button" class="webstory-trigger" aria-label="<?php echo esc_attr($story['title']); ?>"
                                data-story="<?php echo esc_attr($story['key']); ?>"
                                data-cover="<?php echo esc_url($story['image']); ?>"
                                data-title="<?php echo esc_attr($story['title']); ?>">
                                <span class="webstory-thumb">
                                    <span class="webstory-thumb-fill"
                                        style="background-image: url('<?php echo esc_url($story['image']); ?>');"
                                        aria-hidden="true"></span>
                                    <span class="webstory-chip">Web Story</span>
