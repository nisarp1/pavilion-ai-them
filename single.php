            ...
            <div class="post-sb-page__main-pic post-sb-page__main-pic--inner">
                ...
                <div class="post-sb-page__title">
                    ...
                    if (!empty($categories)) : 
                        ...
                        $cat_id = is_array($first_cat) ? (isset($first_cat['id']) ? $first_cat['id'] : null) : (isset($first_cat->id) ? $first_cat->id : (isset($first_cat->term_id) ? $first_cat->term_id : null));
                        $cat_name = is_array($first_cat) ? (isset($first_cat['name']) ? $first_cat['name'] : '') : (isset($first_cat->name) ? $first_cat->name : '');
                        if ($cat_id && $cat_name) :
                    ?>
                        <a class="post-sb-page__tag" href="<?php echo esc_url(get_category_link($cat_id)); ?>"><?php echo esc_html($cat_name); ?></a>
                    <?php 
                        endif;
                    endif; 
                    ?>
