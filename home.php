                                            ...
                                            <?php if (has_post_thumbnail()): ?>
                                                <a href="<?php the_permalink(); ?>" class="image-link">
                                                    <?php the_post_thumbnail('large', array(
                                                        'class' => 'img-fluid img-border-radius',
                                                        'alt' => get_the_title(),
                                                        'loading' => 'eager',     // Disable native lazy loading for LCP
                                                        'fetchpriority' => 'high' // Prioritize fetching this resource
                                                    )); ?>
                                                </a>
                                            <?php else: ?>
                                                <a href="<?php the_permalink(); ?>" class="image-link">
        ...
        <?php if (!empty($video_posts)): ?>
            <div class="video-track" role="list">
                ...
                foreach ($video_posts as $video_post_raw):
                    ...
                    if (!$thumb_url) {
                        $thumb_url = get_stylesheet_directory_uri() . '/assets/images/placeholder.svg';
                    }
