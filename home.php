...
<section class="webstories-section p-b-xs-30 post-section section-gap">
    <div class="container">
        ...
        <div class="webstories-hidden-cards" aria-hidden="true" style="display:none;">
            ...
            ?>
            <article class="webstory-card webstory-card--hidden" role="listitem" data-story="<?php echo esc_attr($story_key); ?>" data-cover="<?php echo esc_url($story_image_url); ?>" data-title="<?php echo esc_attr($story_title); ?>" data-published="<?php echo esc_attr($story_published); ?>">
                <button type="button" class="webstory-trigger" aria-label="<?php echo esc_attr($story_title); ?>" data-story="<?php echo esc_attr($story_key); ?>" data-cover="<?php echo esc_url($story_image_url); ?>" data-title="<?php echo esc_attr($story_title); ?>" data-published="<?php echo esc_attr($story_published); ?>">
                    <span class="webstory-thumb">
                        <span class="webstory-thumb-fill" style="background-image: url('<?php echo esc_url($story_image_url); ?>');" aria-hidden="true"></span>
                        <span class="webstory-chip">Web Story</span>
        ...
        <div class="webstories-track webstories-track--fallback" role="list">
            ...
            <article class="webstory-card" role="listitem" data-story="<?php echo esc_attr($fallback_story['key']); ?>" data-cover="<?php echo esc_url($fallback_story['image']); ?>" data-title="<?php echo esc_attr($fallback_story['title']); ?>">
                <button type="button" class="webstory-trigger" aria-label="<?php echo esc_attr($fallback_story['title']); ?>" data-story="<?php echo esc_attr($fallback_story['key']); ?>" data-cover="<?php echo esc_url($fallback_story['image']); ?>" data-title="<?php echo esc_attr($fallback_story['title']); ?>">
                    <span class="webstory-thumb">
                        <span class="webstory-thumb-fill" style="background-image: url('<?php echo esc_url($fallback_story['image']); ?>');" aria-hidden="true"></span>
                        <span class="webstory-chip">Web Story</span>
        ...
        <div class="webstory-hidden" aria-hidden="true">
            ...
            <div class="webstory-slide-collection" data-story="<?php echo esc_attr($fallback_story['key']); ?>">
                <div class="webstory-slide" data-story="<?php echo esc_attr($fallback_story['key']); ?>" data-caption="<?php echo esc_attr($fallback_story['title']); ?>">
                    <img src="<?php echo esc_url($fallback_story['image']); ?>" alt="<?php echo esc_attr($fallback_story['title']); ?>" class="webstory-slide-image">
        ...
        <div class="container px-4">
                ...
                <div class="col-lg-3">
                    <main class="axil-content medium-section">
                        ...
                        <?php if (!empty($latest_other_posts)) : ?>
                            <?php foreach ($latest_other_posts as $post_item) : setup_postdata($post_item); ?>
                        <a href="<?php the_permalink(); ?>" class="block-link">
            ...
            <div class="col-lg-5">
                <aside class="main-lead-section">
                    ...
                    <?php if ($top_news_featured) : setup_postdata($top_news_featured); ?>
                    <div class="live-card">
                        <a href="<?php the_permalink(); ?>" class="block-link">
                            <div class="flex-1">
                                <h3 class="featured-title"><?php the_title(); ?></h3>
                    ...
                    <?php if (!empty($top_news_list)) : ?>
                        <?php foreach ($top_news_list as $post_item) : setup_postdata($post_item); ?>
                    <a href="<?php the_permalink(); ?>" class="block-link">
                        <div class="media post-block small-block">
                            <div class="post-image-wrapper">
                                <?php if (has_post_thumbnail()) : ?>
    ...
    <div class="container">
        ...
        <div class="video-track" role="list">
            ...
            foreach ($video_posts as $video_post_raw) :
                ...
                if (!$thumb_url) {
                    $thumb_url = get_stylesheet_directory_uri() . '/assets/images/new/hero.jpg';
                }
            ...
            <article class="webstory-card video-story-card" role="listitem">
                <a href="<?php the_permalink(); ?>" class="video-story-trigger">
                    <span class="webstory-thumb">
                        <span class="webstory-thumb-fill" style="background-image: url('<?php echo esc_url($thumb_url); ?>');" aria-hidden="true"></span>
                        <span class="video-play-icon" aria-hidden="true"></span>
                        <span class="webstory-title"><?php the_title(); ?></span>
                        <span class="video-story-time"><i class="far fa-clock"></i> <?php echo meks_time_ago(); ?></span>
                    </span>
                </a>
            </article>
            <?php
...
<section class="post-section section-gap">
    <div class="random-posts">
        <div class="container px-4">
            ...
            <div class="row">
                <?php foreach ($regional_big_posts as $post_item) : setup_postdata($post_item); ?>
                <div class="col-lg-4">
    ...
    <div class="row">
                <?php foreach ($regional_small_posts as $post_item) : setup_postdata($post_item); ?>
        <div class="col-lg-4">
            <a href="<?php the_permalink(); ?>" class="block-link">
                <div class="media post-block small-block">
                    <div class="post-image-wrapper">
        ...
        <aside class="post-sidebar medium-section">
            ...
            <div class="section-title m-b-xs-10">
                ...
                if (!$regional_category) {
                    ...
                    <p class="regional-empty-state">Add posts to the Regional Football category to populate this block.</p>
                <?php
                } else {
            ...
            ?>
            <?php if ($uae_featured) : setup_postdata($uae_featured); ?>
            <div class="live-card">
                <div class="flex-1">
                    <a href="<?php the_permalink(); ?>" class="title-link">
                        <h3 class="featured-title"><?php the_title(); ?></h3>
            ...
            <?php if (!empty($uae_other_posts)) : ?>
                <?php foreach ($uae_other_posts as $post_item) : setup_postdata($post_item); ?>
            <a href="<?php the_permalink(); ?>" class="block-link">
                <div class="media post-block small-block">
                    <div class="post-image-wrapper">
                        <?php if (has_post_thumbnail()) : ?>
    ...
    <div class="col-lg-4">
        <main class="axil-content big-section">
            ...
            <?php if (!empty($isl_other_posts)) : ?>
                <?php foreach ($isl_other_posts as $post_item) : setup_postdata($post_item); ?>
                <a href="<?php the_permalink(); ?>" class="block-link">
                    <div class="media post-block small-block">
                        <div class="post-image-wrapper">
                            <?php if (has_post_thumbnail()) : ?>
