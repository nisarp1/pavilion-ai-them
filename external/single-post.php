                    ...
                    <div class="post-title-wrapper">
                        ...
                        <div class="post-metas banner-post-metas">
                            <ul class="list-inline">
                                ...
                                <li><a href="#"><i
                                            class="feather icon-activity"></i><?php echo get_post_views(get_the_ID()); ?>
                                        Views</a></li>
                                <li><a href="#"><i class="feather icon-share-2"></i><?php echo get_share_count(); ?>
                                        Shares</a></li>
                            </ul>
                        </div>
                        <!-- End of .post-metas -->
                ...
                <div class="col-lg-8">
                    <main class="site-main">
                        ...
                        <div class="facebook-comments-section m-b-xs-60">
                            ...
                            <div class="fb-comments" data-href="<?php echo get_permalink(); ?>" data-width="100%"
                                data-numposts="5" data-colorscheme="light" data-order-by="social">
                            </div>
                        </div>
                    ...
                    if ($gallery_posts->have_posts()):
                        ...
                        while ($gallery_posts->have_posts()):
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="axil-img-container flex-height-container gallery-container__type-2 m-b-xs-30"
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="axil-img-container flex-height-container gallery-container__type-2 m-b-xs-30"
                                data-gallery="gallery-fallback-1">
                                <div class="gallery-image-wrapper d-block h-100">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/new/vs.jpg"
                                        alt="VS Achuthanandan Gallery" class="w-100">
                                    <div class="grad-overlay grad-overlay__transparent"></div>
                                    <div class="gallery-icon gallery-play-btn">
                                        <i class="fas fa-expand"></i>
                                    </div>
                                ...
                                <div class="media post-block grad-overlay__transparent position-absolute">
                                    <div class="media-body media-body__big">
                                        <div class="axil-media-bottom mt-auto">
                                            <h3 class="axil-post-title hover-line">ജനനായകന്റെ അന്ത്യയാത്ര: വി.എസ്. അച്യുതാനന്ദൻ
                                                വിട</h3>
                                        </div>
                                    </div>
                                    <!-- End of .media-body -->
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="axil-img-container flex-height-container gallery-container__type-2 m-b-xs-30"
                                data-gallery="gallery-fallback-2">
                                <div class="gallery-image-wrapper d-block h-100">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/new/dubai1.jpg"
                                        alt="Dubai Festival Gallery" class="w-100">
                                    <div class="grad-overlay grad-overlay__transparent"></div>
                                    <div class="gallery-icon gallery-play-btn">
                                        <i class="fas fa-expand"></i>
                                    </div>
                                ...
                                <div class="media post-block grad-overlay__transparent position-absolute">
                                    <div class="media-body media-body__big">
                                        <div class="axil-media-bottom mt-auto">
                                            <h3 class="axil-post-title hover-line">വർണ്ണവിസ്മയങ്ങളുടെ ദുബായ്: ഫെസ്റ്റിവൽ കാഴ്ചകൾ
                                            </h3>
                                        </div>
                                    </div>
                                    <!-- End of .media-body -->
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="axil-img-container flex-height-container gallery-container__type-2 m-b-xs-30"
                                data-gallery="gallery-fallback-3">
                                <div class="gallery-image-wrapper d-block h-100">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/new/uae.jpg"
                                        alt="UAE National Day Gallery" class="w-100">
                                    <div class="grad-overlay grad-overlay__transparent"></div>
                                    <div class="gallery-icon gallery-play-btn">
                                        <i class="fas fa-expand"></i>
                                    </div>
                                ...
                                <div class="media post-block grad-overlay__transparent position-absolute">
                                    <div class="media-body media-body__big">
                                        <div class="axil-media-bottom mt-auto">
                                            <h3 class="axil-post-title hover-line">ചതുർവർണ്ണ പതാകയേന്തി ഒരു ജനത: ദേശീയ ദിനാഘോഷം
                                            </h3>
                                        </div>
                                    </div>
                                    <!-- End of .media-body -->
                        ...
                        <div style="display: none;">
                            <div class="gallery-slide" data-gallery="gallery-fallback-1">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/new/vs.jpg"
                                    alt="VS Achuthanandan Gallery" class="gallery-slide-image">
                            ...
                            <div class="gallery-slide" data-gallery="gallery-fallback-2">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/new/dubai1.jpg"
                                    alt="Dubai Festival Gallery" class="gallery-slide-image">
                            ...
                            <div class="gallery-slide" data-gallery="gallery-fallback-3">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/new/uae.jpg"
                                    alt="UAE National Day Gallery" class="gallery-slide-image">
