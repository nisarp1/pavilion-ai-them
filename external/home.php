            ...
            <main class="axil-content big-section">
                ...
                <a href="<?php echo get_permalink($post->ID); ?>" class="block-link">
                    <div class="media post-block small-block">
                        ...
                        <div class="media-body">
                            <h4 class="axil-post-title small-card-title"><?php echo get_the_title($post->ID); ?></h4>
                            <div class="d-flex align-items-center flex-nowrap">
                                <div class="post-cat-group flex-shrink-0">
                                    <?php
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="axil-content">
                    <?php
                    // Get 5 other posts from Video category (excluding the featured one)
                    $other_posts = new WP_Query(array(
                        'category_name' => 'video',
                        'posts_per_page' => 5,
                        'offset' => 1, // Skip the featured post already shown on the left
                        'post_status' => 'publish'
                    ));
        ...
        <div class="col-lg-4">
            <a href="#" class="block-link">
                <div class="media post-block small-block">
                    ...
                    <div class="media-body">
                        <h4 class="axil-post-title small-card-title">Sample Kerala News Post</h4>
                        <div class="d-flex align-items-center flex-nowrap">
                            <div class="post-cat-group flex-shrink-0">
        ...
        <div class="col-lg-4">
            <a href="#" class="block-link">
                <div class="media post-block small-block">
                    ...
                    <div class="media-body">
                        <h4 class="axil-post-title small-card-title">Another Kerala News Post</h4>
                        <div class="d-flex align-items-center flex-nowrap">
                            <div class="post-cat-group flex-shrink-0">
        ...
        <div class="col-lg-4">
            <a href="#" class="block-link">
                <div class="media post-block small-block">
                    ...
                    <div class="media-body">
                        <h4 class="axil-post-title small-card-title">Third Kerala News Post</h4>
                        <div class="d-flex align-items-center flex-nowrap">
                            <div class="post-cat-group flex-shrink-0">
