...
// API Configuration
define('PAVILION_API_BASE_URL', 'http://localhost:8000/api'); // Update this to your pavilion-gemini API URL
...
function get_bloginfo($show = '') {
    ...
    switch ($show) {
        case 'name':
            return isset($site_data['name']) ? $site_data['name'] : 'Byline Gulf';
        case 'description':
